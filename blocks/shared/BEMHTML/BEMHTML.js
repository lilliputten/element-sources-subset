/* jshint camelcase:false, unused:false, laxbreak:true, expr:true, boss:true, asi:true, eqeqeq:false, curly:false, noempty:false */
/* globals modules, BEMHTML */
/**
 *
 * Patched base.bemhtml.js
 *
 * Для патча: `diff -u base.bemhtml.js BEMHTML.js > BEMHTML.js.diff`
 *
 * @version 2017.03.07, 06:56
 *
 * $Date: 2017-07-11 19:47:15 +0300 (Tue, 11 Jul 2017) $
 * $Id: BEMHTML.js 8733 2017-07-11 16:47:15Z miheev $
 *
 * [](https://github.com/bem-site/bem-forum-content-ru/issues/1198#issuecomment-294427648)
 *
 * ```shell
 * $ echo "" | bem-xjst -o core.bemhtml.js
 * ```
 * Версия bem-xjst:
 * ```json
 *     "bem-xjst": "^7.7.4"
 * ```
 *
 * Изменён код во измежание предупреждений jshint. См. ниже:
 * ```js
 * rb: 1, rt: 1, rtc: 1, rp: 1, optgroup: 1 // XXX 2017.06.26, 18:24 -- lines changed due to jshint warning "Label 'rb' on 1 statement" and so on
 * ```
 *
 *
 */

// Если BMHTML ещё не инициализирован и запущены не на enb (8080) и не на nginx (5590) сервере...
/*{{{ Check global BEMHTML */if ( typeof BEMHTML === 'undefined'
    // /*DEBUG*/ && ( window.location.host != 'localhost' /* && window.location.port != '5590' */ && window.location.port != '8080' )
    /* && ( typeof PROJECT_CONFIG_MODE === 'undefined' && PROJECT_CONFIG_MODE !== 'enb' ) */
) {
...
var OPTIONAL_END_TAGS = {
  ...
  // /* dl — Neither tag is omissible */ rb: 1, rt: 1, rtc: 1, rp: 1, optgroup: 1 /* jshint -W028 */ // jshint ignore:line
  rb: 1, rt: 1, rtc: 1, rp: 1, optgroup: 1 // XXX 2017.06.26, 18:24 -- lines changed due to jshint warning "Label 'rb' on 1 statement" and so on
};
...
/// -------------------------------------
    ...
    if (typeof modules === 'object') {
        ...
        // defineAsGlobal = false; // XXX: Always creating global object!
    }
