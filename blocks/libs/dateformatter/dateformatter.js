/* jshint camelcase:false, unused:false, browser:true */
/* globals modules, project */

modules.define('dateformatter', [], function(provide) {

/*{{{ include:php-date-formatter-1.3.4.js */
/*!
...
__global.DateFormatter = DateFormatter;
